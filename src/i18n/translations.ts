...
const en: TranslationDict = {
  ...
  "hospitality.title": "Hospitality and Service Policy",
...
const sl: TranslationDict = {
  ...
  "hospitality.title": "Politika gostoljubnosti in postrežbe",
  "hospitality.intro": "ŽIVA VERA je neprofitna kavarna, ki deluje kot poslanstvo Krščanske cerkve Kalvarija. Naše delovanje temelji na prostovoljnem delu, prostovoljnih prispevkih obiskovalcev ter želji ustvarjati prijeten, varen in spoštljiv prostor za vse ljudi.",
